...
clear
echo -e $yellow '[>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>]'
echo -e $yellow '['$green'              The Script By: Hacker-BoyBS'$yellow'              ]'
echo -e $yellow '['$green'               Facebook: Hacker.BoyBS.sy'$yellow'               ]'
echo -e $yellow '['$green'                Telegram: T.me/HackerB'$yellow'                ]'
...
echo '# Surname: HackerBoyBS'
echo '# My Age: 23 Years old'
echo '# From: Pakistan'
echo '# Skills: Programmer Bash+Python and Hacker'
echo '↓↓↓↓↓↓↓↓↓↓↓ ↓↓↓↓↓↓↓↓↓↓↓↓↓↓'
echo '+ Instagram: HackerBoyBS'
echo '+ Telegram: T.me/HackerB'
echo '+ Whatsapp: +923162518126'
echo '+ Facebook: HackerBoyBS.Sy'
echo '+ Github: github.com/HackerBoy'
echo -e $red
